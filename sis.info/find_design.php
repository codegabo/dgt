...
<body>
    ...
    while($row1=$resultado->fetch_assoc()) {
        ...
        <label for="users-search" class="design-search-label">
            <form action="buscar.php" method="post" name="busqueda" autocomplete="off">
                ...
                <button  type="submit" value="Buscar" name="btn1" class="busc">
                    <img src="img/icons/search-icon.png" class="users-search-icon icon2" alt="" >
                </button>
            </form>
        </label>
        ...
        <main class="data-container">
            ...
            $query2="SELECT * FROM disenos WHERE id_categoria = '$id' AND id_diseno_padre = '0' AND etiquetas like '%bus%' ORDER BY id_diseno desc";
